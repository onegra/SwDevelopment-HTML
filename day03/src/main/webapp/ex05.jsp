...
<%
	...
	out.print("<p>test : "+request.getAttribute("test1")+ "</p>");
	out.print("<p>test : "+request.getAttribute("test2")+ "</p>");
	out.print("<p>test : "+request.getAttribute("test3")+ "</p>");
	out.print("<p>test : "+request.getAttribute("test4")+ "</p>");
%>
